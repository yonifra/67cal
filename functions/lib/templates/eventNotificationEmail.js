...
exports.buildTimeChangedEmail = buildTimeChangedEmail;
exports.buildCancelledEmail = buildCancelledEmail;
const params_1 = require("firebase-functions/params");
const APP_URL = (0, params_1.defineString)('APP_URL', { default: 'https://67cal.com' });
...
function buildTimeChangedEmail(ctx, lang) {
...
function buildCancelledEmail(ctx, lang) {
    const appUrl = APP_URL.value();
    const eventUrl = `${appUrl}/${lang}/calendar/${ctx.calendarId}/event/${ctx.eventId}`;
    if (lang === 'he') {
...
//# sourceMappingURL=eventNotificationEmail.js.map